...
<div class="row">
    <div class="col-md-12 col-sm-12 col-xs-12">
        ...
        <div class="x_content">
          <br>
          <form id="demo-form2" action="{{route('product.store')}}" method="post" class="form-horizontal form-label-left" enctype="multipart/form-data">
       @csrf
       <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <label class="control-label col-md-3 col-sm-3 col-xs-12" for="name">Product Price <span class="required">*</span></label>
                              <div class="col-md-6 col-sm-6 col-xs-12">
                              <input  type="number"   class="form-control col-md-7 col-xs-12" name="price" required =" ">
                              </div>
                            </div>
                        </div>
                        <div class="form-group">
